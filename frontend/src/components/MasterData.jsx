...
const FORMULA_DEFAULTS = [
  ...
  { section:"Project TAT", accent:"#dc2626", id:"target_days",
    label:"Target Days",
    formula:"Working days (per Working Days in Company Settings) planned for the project, from start date to end date (both included). Weekends/non-working days in that range are not counted.",
    example:"Example: Project runs Mon Apr 6 to Fri Apr 10 = 5 target days. If it instead ran Mon Apr 6 to Mon Apr 13 (spanning a Sat–Sun), that's 6 target days, not 8.",
    source:"project", sourceLabel:"Project start & end date + Working Days" },
  ...
  { section:"Project TAT", accent:"#dc2626", id:"actual_days",
    label:"Actual Days",
    formula:"Working days (per Working Days in Company Settings) from the project start date to the reference date (minimum 1). Weekends/non-working days are not counted.",
    example:"Example: Started Mon Apr 6, reference date Fri Apr 24 — only the working days in that span are counted, not every calendar day.",
    source:"project", sourceLabel:"Project start date + Working Days" },
  { section:"Project TAT", accent:"#dc2626", id:"tat_overrun",
    label:"TAT Overrun (days)",
    formula:"How many working days (per Working Days in Company Settings) the project ran past its planned end. If on time or early, this is 0.",
    example:"Example: Target 5 working days, actual 8 working days → 3 working days overrun.",
  ...
  { section:"Work Status", accent:"#3b82f6", id:"delayed",
    label:"Delayed",
    formula:"A work log entry is Delayed if it was logged after the project's end date has passed. The number of days late (shown as +Xd) counts only working days per Working Days in Company Settings — weekends/non-working days in between are not counted.",
    example:"Example: Project ends Fri Apr 10, task logged Mon Apr 13 → 1 working day late (the Sat–Sun in between doesn't count).",
    source:"worklog", sourceLabel:"Set in Worklog + Working Days" },
