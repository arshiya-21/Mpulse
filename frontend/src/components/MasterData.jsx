...
const FORMULA_DEFAULTS = [
  ...
  { section:"Utilization Charts",   accent:"#7c3aed", id:"emp_util_bar",  label:"Employee Utilization % (Bar Chart)", formula:"For each employee, all their individual task utilizations in the selected date range are added together to get a total. A higher total means the employee contributed more work overall during the period.", example:"Example: Employee logged 4 tasks with 50%, 60%, 40%, 70% utilization → 50+60+40+70 = 220% total shown in the bar.", source:"worklog", sourceLabel:"Worklog entries" },
  { section:"Utilization Charts",   accent:"#7c3aed", id:"dept_util_bar", label:"Department Utilization % (Bar Chart)", formula:"All tasks logged by employees in a department are collected and their individual utilization values are summed. A higher total means the department as a whole logged more work in the selected date range.", example:"Example: Department has 3 tasks with 60%, 80%, 70% → 60+80+70 = 210% total for the department.", source:"worklog", sourceLabel:"Worklog entries" },
